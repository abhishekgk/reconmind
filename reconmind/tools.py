...
TOOLBOX: list[Tool] = [
    ...
    Tool("gospider", "Fast web spider (crawl depth, sitemap/robots, JS)",
         "go install github.com/jaeles-project/gospider@latest"),
    Tool("hakrawler", "Quick crawler for endpoints in JS/HTML",
         "go install github.com/hakluke/hakrawler@latest"),
    Tool("urlfinder", "Passive URL discovery across archives (ProjectDiscovery)",
